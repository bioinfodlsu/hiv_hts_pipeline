...
# rule last_db_single: #Rule for constructing LAST index
#     input:
#         reference = config["reference"]
#     output:
#        touch("{0}/last_index/index_single.done".format(config["out_dir"]))
#     params:
...
# rule last_score_training_single: #Rule for training score parameters
#     input:
#         reference_flag = "{0}/last_index/index_single.done".format(config["out_dir"]),
