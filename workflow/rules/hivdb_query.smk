...
#     output:
#         "{0}".format(config['out_dir'])+"/variants/{country}/{sample_id}_to_{reference_name}/paramgroup_{param_group}/filtered/variants_{aligner}_{lofreq_param_group}.json"
#     conda:
#         "../envs/vcfToHivdb.yaml"
#     shell:
#         "python workflow/scripts/vcfToHivdb.py --vcfFile {input} --outFile {output}"
...
#         "{0}".format(config['out_dir'])+"/variants/{country}/{sample_id}_to_{reference_name}/paramgroup_{param_group}/filtered/variants_{aligner}_{lofreq_param_group}.json"
#     output:
#         "{0}".format(config['out_dir'])+"/drug_resistance_report/{country}/{sample_id}_to_{reference_name}/paramgroup_{param_group}/filtered/results_{aligner}_{lofreq_param_group}.txt"
#     conda:
#         "../envs/vcfToHivdb.yaml"
#     shell:
#         "python workflow/scripts/tabulateJson.py --jsonFile {input} --outFile {output}"
